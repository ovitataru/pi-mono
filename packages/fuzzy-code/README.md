...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@fuzzyos/fuzzy-code"><img alt="npm" src="https://img.shields.io/npm/v/@fuzzyos/fuzzy-code?style=flat-square" /></a>
  <a href="https://github.com/fuzzyos/fuzzyos/actions/workflows/ci.yml"><img alt="Build status" src="https://img.shields.io/github/actions/workflow/status/fuzzyos/fuzzy-code/ci.yml?style=flat-square&branch=main" /></a>
</p>
<p align="center">
  <a href="https://fuzzyos.com">fuzzyos.com</a> domain graciously donated by
  <br /><br />
  <a href="https://exe.dev"><img src="docs/images/exy.png" alt="Exy mascot" width="48" /><br />exe.dev</a>
</p>

Fuzzy is a minimal terminal coding harness. Adapt fuzzy to your workflows, not the other way around, without having to fork and modify fuzzy internals. Extend it with TypeScript [Extensions](#extensions), [Skills](#skills), [Prompt Templates](#prompt-templates), and [Themes](#themes). Put your extensions, skills, prompt templates, and themes in [Fuzzy Packages](#pi-packages) and share them with others via npm or git.
...
If you use fuzzy for open source work, please share your coding agent sessions.

Public OSS session data helps improve models, prompts, tools, and evaluations using real development workflows.

For the full explanation, see [this post on X](https://x.com/badlogicgames/status/2037811643774652911).

To publish sessions, use [`badlogic/pi-share-hf`](https://github.com/fuzzyos/pi-share-hf). Read its README.md for setup instructions. All you need is a Hugging Face account, the Hugging Face CLI, and `pi-share-hf`.

You can also watch [this video](https://x.com/badlogicgames/status/2041151967695634619), where I show how I publish my `fuzzyos` sessions.

I regularly publish my own `fuzzyos` work sessions here:

- [badlogicgames/fuzzyos on Hugging Face](https://huggingface.co/datasets/badlogicgames/fuzzyos)
...
Then just talk to pi. By default, fuzzy gives the model four tools: `read`, `write`, `edit`, and `bash`. The model uses these to fulfill your requests. Add capabilities via [skills](#skills), [prompt templates](#prompt-templates), [extensions](#extensions), or [pi packages](#pi-packages).
...
Without a `pi` manifest, fuzzy auto-discovers from conventional directories (`extensions/`, `skills/`, `prompts/`, `themes/`).
...
Fuzzy is aggressively extensible so it doesn't have to dictate your workflow. Features that other tools bake in can be built with [extensions](#extensions), [skills](#skills), or installed from third-party [pi packages](#pi-packages). This keeps the core minimal while letting you shape fuzzy to fit how you work.

**No MCP.** Build CLI tools with READMEs (see [Skills](#skills)), or build an extension that adds MCP support. [Why?](https://fuzzyos.com/posts/2025-11-02-what-if-you-dont-need-mcp/)
...
Read the [blog post](https://fuzzyos.com/posts/2025-11-30-pi-coding-agent/) for the full rationale.
...
|----------|-------------|
| `FUZZY_CODING_AGENT_DIR` | Override config directory (default: `~/.pi/agent`) |
