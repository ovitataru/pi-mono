...
The SDK provides programmatic access to pi's agent capabilities. Use it to embed fuzzy in other applications, build custom interfaces, or integrate with automated workflows.
