...
# Parse arguments passed from fuzzy CLI
MOUNT_COMMAND=""
MODELS_PATH=""
HF_TOKEN=""
FUZZY_API_KEY=""
...
if [ -z "$FUZZY_API_KEY" ]; then
    echo "ERROR: FUZZY_API_KEY is required" >&2
    exit 1
fi
...
# --- Output GPU info for fuzzy CLI to parse -------------------------------------
echo ""
echo "===GPU_INFO_START==="
