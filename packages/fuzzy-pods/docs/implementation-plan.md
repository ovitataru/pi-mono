...
- [ ] `src/setup/generate-setup-script.ts` - Generate bash script as string
  ...
  - [ ] Generate env var setup (HF_TOKEN, FUZZY_API_KEY)
...
- [ ] `src/commands/pods-setup.ts` - fuzzy pods setup
  - [ ] Parse args (name, ssh, mount)
  - [ ] Check env vars (HF_TOKEN, FUZZY_API_KEY)
  - [ ] Call setup executor
  - [ ] Save pod to config

- [ ] `src/commands/pods-list.ts` - fuzzy pods
  - [ ] Load config
  - [ ] Display all pods with active marker

- [ ] `src/commands/pods-active.ts` - fuzzy pods active
  - [ ] Switch active pod
  - [ ] Update config

- [ ] `src/commands/pods-remove.ts` - fuzzy pods remove
...
- [ ] `src/commands/start.ts` - fuzzy start
...
- [ ] `src/commands/stop.ts` - fuzzy stop
  - [ ] Find model in config
  - [ ] Kill process via PID
  - [ ] Clean up config

- [ ] `src/commands/list.ts` - fuzzy list
  - [ ] Show models from config
  - [ ] Optionally verify PIDs

- [ ] `src/commands/logs.ts` - fuzzy logs
...
- [ ] `src/commands/prompt.ts` - fuzzy prompt
