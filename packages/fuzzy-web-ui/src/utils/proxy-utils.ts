import type { Api, Context, Model, SimpleStreamOptions } from "@fuzzyos/fuzzy-ai";
import { streamSimple } from "@fuzzyos/fuzzy-ai";
 ...
 * @param apiKey - API key for the provider
 * @param proxyUrl - CORS proxy URL (e.g., "https://proxy.fuzzyos.com/proxy")
