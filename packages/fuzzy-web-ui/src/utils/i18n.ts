import { defaultEnglish, defaultGerman, type MiniLitRequiredMessages, setTranslations } from "@fuzzyos/mini-lit";

declare module "@fuzzyos/mini-lit" {
...
export * from "@fuzzyos/mini-lit/dist/i18n.js";
