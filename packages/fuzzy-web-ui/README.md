...
```bash
npm install @fuzzyos/fuzzy-web-ui @fuzzyos/fuzzy-agent @fuzzyos/fuzzy-ai
```
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@fuzzyos/fuzzy-web-ui';
import '@fuzzyos/fuzzy-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { SessionListDialog } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { ModelSelector } from '@fuzzyos/fuzzy-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@fuzzyos/fuzzy-web-ui';
