 ...
 * Defaults to "short" and uses FUZZY_CACHE_RETENTION for backward compatibility.
 */
function resolveCacheRetention(cacheRetention?: CacheRetention): CacheRetention {
	if (cacheRetention) {
		return cacheRetention;
	}
	if (typeof process !== "undefined" && process.env.FUZZY_CACHE_RETENTION === "long") {
		return "long";
	}
	return "short";
}
...
// Source: https://cchistory.fuzzyos.com/data/prompts-2.1.11.md
// To update: https://github.com/fuzzyos/cchistory
